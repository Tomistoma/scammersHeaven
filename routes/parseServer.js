...
setTimeout(()=>{
  ...
  mammoth.convertToHtml({path: 'build/static/media/'+req.params.section+'.docx'})
  .then(function(result){
  html = result.value; // The generated HTML C:\Users\tomas\Coding\ukforum\frontend\src\InfoContent
  fs.writeFile(path.join(__dirname, "..",'build', 'static', 'media', req.params.section+".html"), result.value, function (err) {
